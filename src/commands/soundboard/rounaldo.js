...
module.exports = async (client, interaction, args) => {
    ...
    client.soundboard(interaction.guild.id, interaction, "https://www.myinstants.com/media/sounds/ronaldo-siuuuu.mp3");

    client.succNormal({ text: "Soundboard started! Playing **Ronaldo siuuuuu**", type: 'editreply' }, interaction);
};